...
|:-----|:-----|:------------|
| Function | [read-file](../api/read-file) | ファイルを読み込み |
| Function | [write-file](../api/write-file) | ファイルに書き込み |
| Function | [append-file](../api/append-file) | ファイルに追記 |
| Function | [file-exists?](../api/file-exists-p) | ファイルの存在確認 |
