...
|:-----|:-----|:------------|
| Special Form | [error](../api/error) | エラーを送出 |
| Special Form | [ignore-errors](../api/ignore-errors) | エラーを無視して nil を返す |
| Special Form | [handler-case](../api/handler-case) | エラーを捕捉してハンドラを実行 |
| Special Form | [unwind-protect](../api/unwind-protect) | クリーンアップを保証 |
