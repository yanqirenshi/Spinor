...
| Special Form | [fn](../api/fn) | 関数を作成 |
| Special Form | [defpackage](../api/defpackage) | 新しいパッケージを定義 |
| Special Form | [in-package](../api/in-package) | カレントパッケージを切り替え |
| Special Form | [use-package](../api/use-package) | 他パッケージのシンボルをインポート |
| Special Form | [export](../api/export) | シンボルをエクスポート |
| Function | [current-package](../api/current-package) | カレントパッケージ名を取得 |
