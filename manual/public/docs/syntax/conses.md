...
|:-----|:-----|:------------|
| Function | [cons](../api/cons) | コンスセルを作成 |
| Function | [car](../api/car) | コンスセルの先頭要素を取得 |
| Function | [cdr](../api/cdr) | コンスセルの残りを取得 |
| Function | [list](../api/list) | リストを作成 |
| Function | [nil?](../api/nil-p) | `nil` かどうかを判定 |
| Function | [empty?](../api/empty-p) | 空リストかどうかを判定 |
| Special Form | [quote](../api/quote) | 評価を抑制してリストを作成 |
| Special Form | [match](../api/match) | パターンマッチでリストを分解 |
