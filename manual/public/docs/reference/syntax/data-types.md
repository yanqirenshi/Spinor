...
|:-----|:-----|:------------|
| Special Form | [data](../api/data) | 代数的データ型を定義 |
| Special Form | [match](../api/match) | パターンマッチによる分岐 |
| Function | [list](../api/list) | リストを作成 |
| Function | [cons](../api/cons) | 要素とリストを結合 (パターンでも使用) |
| Function | [car](../api/car) | リストの先頭要素を取得 |
| Function | [cdr](../api/cdr) | リストの残りを取得 |
