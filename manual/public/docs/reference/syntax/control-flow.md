...
|:-----|:-----|:------------|
| Special Form | [if](../api/if) | 条件分岐 |
| Special Form | [let](../api/let) | ローカル変数の束縛 |
| Special Form | [begin](../api/begin) | 複数の式を逐次実行 |
| Special Form | [progn](../api/progn) | `begin` のエイリアス (Common Lisp スタイル) |
| Special Form | [setq](../api/setq) | 変数の値を更新 |
| Function | [>](../api/gt) | 数値の大小比較 |
